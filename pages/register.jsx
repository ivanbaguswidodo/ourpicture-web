...
function Register() {
    ...
    const onChangeProfilePictureInput = e => {
        ...
        if (profilePictureInput) {
            ...
            setProfilePictureField({
                isError: true,
                message: 'Foto Profile wajib diisi',
                value: profilePictureInput,
                key: 'profile_picture'
            })
        }
  ...
  return (
    <div className="flex gap-20 min-h-screen items-center place-content-center">
        <Head>
            <title>Register - OurPicture</title>
        </Head>
        <div className="flex flex-col items-center place-content-center space-y-3 shadow-xl">
            <div className='w-[400px] rounded-lg p-7 space-y-5'>
        ...
        <div className="flex flex-col items-center gap-3 place-content-center">
            <Logo/>
            <Image 
